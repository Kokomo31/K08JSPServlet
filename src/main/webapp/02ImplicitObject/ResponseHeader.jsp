...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%
//get 방식으로 전송된 폼값을 날짜	형식을 통해 타임스템프로 변경한다.
/*
...
<body>
    ...
    이것은 getHeader()메서드의 트성으로 처음 입력한 헤더값만 출력되게 된다.
    */
    %>
    ...
    */
	...
	%>
		<!-- 82802, 1004가 순서대로 출력된다. -->
		<li>myNumber : <%= myNum %></li> 
	<%
	}
	/*
	이처럼 응답헤더에는 개발자가 원하는 값을 추가할 수 있으므로 프로그램에 여러행태로 응용할 수 있다.
	*/
	%>
</body>
</html>
