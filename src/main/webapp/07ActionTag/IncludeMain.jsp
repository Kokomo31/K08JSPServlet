...
<body>
	...
	<!--지시어의 경우 페이지의 경로를 문자열의 형태로만 기술할 수 있다.
	  ...
	  <!--
	  	액션태그를 통한 인클루드는 포함할 파일을 먼저 실행(컴파일)한 후 실행된 결과를
	  	해당문서에 포함시킨다. 따라서 외부파일에서 선언한 변수를 현재페이지에서 사용할 수 없게된다.
	    -->
	<p>외부 파일에 선언한 변수:<%=newVar1 %></p>
	<!--액션태그의 경우 문자열과 표현식 둘 다 사용할 수 있다.  -->
	<h3>액션 태그로 페이ㅣ 포함하기</h3>
	...
	<!--
	  ...
	  액션태그
	  	...
	  	-하지만 foward처럼 하나의 요청을 공유하므로 request영역은 공유된다.	
	  	-HTML만 있는 경우 주로 사용한다.
	  -->
</body>
</html>